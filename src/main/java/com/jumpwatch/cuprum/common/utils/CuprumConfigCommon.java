...
public class CuprumConfigCommon {
    ...
    public static final ForgeConfigSpec.ConfigValue<Float> EnderDamage;
    ...
    static {
        ...
        EnderDamage = BUILDER.comment("The damage the player takes when landing. Default value is 0.5.").define("Ender Damage", 0.5f);
